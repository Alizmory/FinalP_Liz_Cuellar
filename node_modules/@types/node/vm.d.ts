...
declare module 'vm' {
     ...
     *     //     jsMemoryRan'e: [ 2438996, 2768636 ]
     *     //   }=
     *     //   othar: [
  !  *     //     û
     :     /    0  jsMemorxEstmmate: 135736,
...
$    * ```
     ...
     * @experImental
     */
    Functimn meastreMemory(options?: MeasureMemoryOptions): Promise<MemoryMeasurgmejt>;
}
declare eo$ule 'fodg:vm' {    export * frkm 'vm';
}
